...
class FlowerAdmin(admin.ModelAdmin):
    list_display = ('name', 'price', 'rating', 'category', 'is_popular', 'is_new', 'created_at')
    list_filter = ('category', 'created_at', 'rating', 'is_popular', 'is_new')
    search_fields = ('name', 'description')
    list_editable = ('price', 'rating', 'is_popular', 'is_new')
